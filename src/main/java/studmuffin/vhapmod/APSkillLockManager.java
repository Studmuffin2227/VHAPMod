...
public class APSkillLockManager {
    ...
    private static Map<String, String> createSkillAliases() {
        ...
        aliases.put("mega_jump_break_up", "mega_jump_drill");
        aliases.put("mega_jump_drill", "mega_jump_drill");
        aliases.put("mega_jump_break_down", "mega_dig");
        aliases.put("mega_drill", "mega_dig");
        aliases.put("mega_dig", "mega_dig");
        ...
        aliases.put("javelin_sight", "hunter_javelin");
        aliases.put("hunter_javelin", "hunter_javelin");
        aliases.put("mana_barrier", "mana_barrier");
        aliases.put("mana_shield_retribution", "retribution");
        aliases.put("shield_bash_retribution", "retribution");
        aliases.put("retribution", "retribution");
        ...
        aliases.put("stonefall_snow", "heros_landing");
        aliases.put("heros_landing", "heros_landing");
        aliases.put("herolanding", "heros_landing");
        aliases.put("stonefall_cold", "coldsnap");
        aliases.put("coldsnap", "coldsnap");
        aliases.put("coldfall", "coldsnap");
        aliases.put("totem_player_damage", "wrath_totem");
        aliases.put("wrath_totem", "wrath_totem");
        aliases.put("totem_wrath", "wrath_totem");
        aliases.put("totem_mana_regen", "spirit_totem");
        aliases.put("spirit_totem", "spirit_totem");
        aliases.put("totem_spirit", "spirit_totem");
        aliases.put("totem_mob_damage", "hatred_totem");
        aliases.put("hatred_totem", "hatred_totem");
        aliases.put("totem_hatred", "hatred_totem");
        ...
        aliases.put("battle_cry_spectral_strike", "battle_cry_spectral_cry");
        aliases.put("battle_cry_spectral_cry", "battle_cry_spectral_cry");
        aliases.put("spectral_cry", "battle_cry_spectral_cry");
        aliases.put("battle_cry_lucky_strike", "battle_cry_lucky_cry");
        aliases.put("battle_cry_lucky_cry", "battle_cry_lucky_cry");
        aliases.put("lucky_cry", "battle_cry_lucky_cry");
        ...
        aliases.put("chain_lightning_orbs", "ball_lightning");
        aliases.put("ball_lightning", "ball_lightning");
        aliases.put("toxic_grenade", "toxic_vial");
        aliases.put("toxic_vial", "toxic_vial");
        return aliases;
    }
    ...
    private static final Set<String> SPECIALIZATION_KEYS = Set.of(
            ...
            "vhskill:ghost_walk_spirit", "vhskill:mega_jump_drill",
            "vhskill:mega_dig", "vhskill:rampage_leech",
            ...
            "vhskill:hunter_javelin", "vhskill:mana_barrier",
            "vhskill:retribution", "vhskill:implode_life_tap",
            "vhskill:taunt_repel", "vhskill:taunt_charm", "vhskill:heros_landing",
            "vhskill:coldsnap", "vhskill:wrath_totem",
            "vhskill:spirit_totem", "vhskill:hatred_totem",
            ...
            "vhskill:storm_arrow_blizzard", "vhskill:battle_cry_spectral_cry",
            "vhskill:battle_cry_lucky_cry", "vhskill:ice_bolt_blast",
            "vhskill:arcane_rail", "vhskill:earthquake_landmine",
            "vhskill:ball_lightning", "vhskill:toxic_vial"
    );

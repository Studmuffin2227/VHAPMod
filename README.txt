...
A: As the code currently is, most likely. The check tries to send, but is lost as it has nowhere to go. (After connecting to a server once, the mod will auto-attempt to connect you to the most recent AP server)
  -If a check is sent to YOU while you are offline, as long as you have connected to the server once, it should still give you the check.

Any further questions can be asked inside the archipelago discord server, inside the future-game-development post for Vault Hunters.
